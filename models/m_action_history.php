 ...
 // user_id_action 
	...
	public function setLOG_COMMENT($LOG_COMMENT){ 
        ...
        public function getLOG_COMMENT(){
		 ...
		 public function add(){
$this->setQuery("insert into user_action_history(USER_ID_ACTION,ACTION_ID,USER_ID_VICTIM,LOG_TIME,LOG_COMMENT) values  ( '".$this->getUSER_ID_ACTION()."','".$this->getACTION_ID()."','".$this->getUSER_ID_VICTIM()."','".$this->getLOG_TIME()."','".$this->getLOG_COMMENT()."')") ;
