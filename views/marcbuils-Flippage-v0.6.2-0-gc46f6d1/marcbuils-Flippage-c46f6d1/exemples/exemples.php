    ...
    <div   >
        ...
        <div class="exemples" style="  ">
            ...
            <?php for ($i = 0; $i < $num; $i+=2) { ?>
                <div   style="  background: url('../../../../lib/notepad_page_T.png'); margin-left: 0px; " >Page <?php echo $i + 1 ?><br/>
                    <div style="padding: 10px;">   <?php echo $listOfDiary[$i]["DIARY_CONTENT"] ?> </div>
                </div>
                <?php if (($i + 1) < $num) { ?>
                    <div   style="background: url('../../../../lib/notepad_page_T.png');margin-left: -250px; " >Page <?php echo $i + 2 ?><br/>
                       <div style="padding: 10px;">   <?php echo $listOfDiary[$i + 1]["DIARY_CONTENT"] ?> </div>
                    </div>
                <?php }
            }
            ?>
